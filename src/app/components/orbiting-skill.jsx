  ...
  return (
    <main className="w-full flex items-center justify-center overflow-hidden py-10">
      ...
      >
        ...
        <div 
          className="absolute bg-gray-900/80 backdrop-blur-lg rounded-full flex items-center justify-center text-lg font-bold border-2 border-violet-400/30 shadow-[0_0_40px_rgba(6,182,212,0.3)] z-10"
